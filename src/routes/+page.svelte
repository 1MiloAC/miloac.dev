...
>
	...
	<div class="flex-col min-w-80 h-auto md:min-h-screen md:p-8 p-4 md:pt-24">
		...
		<div class="flex md:flex-col flex-row">
			...
			<div class="flex flex-row md:pt-4 md:justify-normal justify-end flex-grow items-center gap-8">
	...
	<div class="flex flex-col xl:flex-row gap-1 w-auto">
		<!-- Main -->
		<div class="flex-col min-w-80 min-h-screen md:pt-18 pt-4 px-4 grow break-words overflow-hidden">
			...
			<p class="mt-2">I am Milo, a developer passionate about code and design.</p>
			<p class="mt-2">
